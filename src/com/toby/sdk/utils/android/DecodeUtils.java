...
import com.android.camera.util.CommonUtils;
import com.android.camera.util.GalleryBitmapPool;
import com.android.camera.util.ThreadPool.CancelListener;
import com.android.camera.util.ThreadPool.JobContext;
...
public class DecodeUtils {
    ...
    public static void decodeBounds(JobContext jc, FileDescriptor fd,
            Options options) {
        CommonUtils.assertTrue(options != null);
...
//            Log.w(TAG, ex);
    ...
    public static Bitmap decodeThumbnail(
        ...
        float scale = (float) targetSize / (type == TYPE_MICROTHUMBNAIL
