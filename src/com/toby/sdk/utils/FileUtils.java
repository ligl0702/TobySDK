...
public class FileUtils {
	...
	public static String calculateMD5(File updateFile) {
		...
		try {
			...
			Trace.e("FileUtils", "Exception while getting digest");
			return null;
		}
		...
		try {
			...
			Trace.e("FileUtils", "Exception while getting FileInputStream");
			return null;
		}
		...
		try {
			...
			try {
				...
				Trace.e("FileUtils", "Exception on closing MD5 input stream");
			}
		}
	}
